...
import com.nathit.newsapp.Models.NewsApiResponse;
...
public class RequestManger {
    ...
    public void getNewsHeadlines(OnFetchDataListener listener, String category, String query) {
        ...
        Call<NewsApiResponse> call = callNewsApi.callHeadline("th", category, query, context.getString(R.string.api_key));
        try {
